...
export type MagiWithoutCreaturesPromptEnteredEffect = PromptEnteredEffectInterface & MagiWithoutCreaturesPromptParams;
...
export type GenericPromptEnteredPromptType = GenericPromptType;
...
export type AnyPromptEnteredEffect = DistributeEnergyPromptEnteredEffect | DistributeDamagePromptEnteredEffect | RearrangeEnergyPromptEnteredEffect | ChooseUpToNCardsFromZonePromptEnteredEffect | ChooseNCardsFromZonePromptEnteredEffect | PlayerPromptEnteredEffect | ChooseCardsPromptPromptEnteredEffect | MayAbilityPromptEnteredEffect | RearrangeCardsOfZonePromptEnteredEffect | DistributeCardsInZonesPromptEnteredEffect | AlternativePromptEnteredEffect | AnyCreatureExceptSourcePromptEnteredEffect | SingleCreatureFilteredPromptEnteredEffect | PaymentSourcePromptEnteredEffect | NumberPromptEnteredEffect | PowerOnMagiPromptEntered | MagiWithoutCreaturesPromptEnteredEffect | GenericPromptEnteredEffect;
export type EffectType = MoveCardBetwenZonesEffect | MoveCardsBetwenZonesEffect | NoneEffect | AttackEffect | CardMovedBetweenZonesEffect | BeforeDrawCardsInDrawStepType | DrawCardsInDrawStepType | DrawNCardsEffect | DiscardEnergyFromCreatureOrMagiEffect | DiscardEnergyFromCreaturesEffect | DiscardEnergyFromCreatureEffect | EnergyDiscardedFromCreatureEffect | DiscardEnergyFromMagiEffect | EnergyDiscardedFromMagiEffect | RemoveEnergyFromCreatureEffect | RemoveEnergyFromMagiEffect | PayingEnergyForPowerEffect | RestoreCreatureToStartingEnergy | StartTurnEffect | StartOfTurnEffect | StartStepEffect | EndOfTurnEffect | DrawEffect | DrawRestOfCardsEffect | MagiFlippedEffect | AddStartingEnergyToMagi | FindStartingCardsEffect | ReshuffleDiscardEffect | AddEnergyToCreatureOrMagiEffect | AddEnergyToCreatureEffect | AddEnergyToMagiEffect | DiscardCreatureOrRelicFromPlay | PayingEnergyForCreatureEffect | PlayCreatureEffect | DiscardReshuffledEffect | DiscardCardsFromHandEffect | DiscardCardFromHandEffect | CreatureEntersPlayEffect | StartingEnergyOnCreatureEffect | PayingEnergyForRelicEffect | PlayRelicEffect | RelicEntersPlayEffect | PlaySpellEffect | PayingEnergyForSpellEffect | ConditionalEffect | AddDelayedTriggerEffect | EnergizeEffect | RollDieEffect | DieRolledEffect | MoveEnergyEffect | MagiIsDefeatedEffect | CreateContinuousEffect | DefeatMagiEffect | RearrangeEnergyEffect | DistributeEnergyEffect | ForbidAttackToCreatureEffect | DistributeDamageEffect | DiscardRelicFromPlayEffect | ReturnCreatureReturningEnergyEffect | ReturnCreatureDiscardingEnergyEffect | DiscardCreatureFromPlayEffect | RearrangeCardsOfZoneEffect | PlayAttachedToCreatureEffect | AttachCardToCardEffect | CardAttachedToCardEffect | ExecutePowerEffect | PlayFinishedEffect | PowerFinishedEffect | DistributeCardsInZonesEffect | TriggerFinishedEffect | AnyPromptEnteredEffect;
export {};
