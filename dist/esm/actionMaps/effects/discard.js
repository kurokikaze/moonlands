...
export const applyDiscardCardsEffect = function (action, transform) {
    const targets = this.getMetaValue(action.target, action.generatedBy);
    oneOrSeveral(targets, target => target && transform({
        type: ACTION_EFFECT,
...
export const applyDiscardCardEffect = function (action, transform) {
...
export const applyReshuffleDiscardEffect = function (action, transform, _state, seeded_nanoid) {
