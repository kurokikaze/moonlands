...
export const applyStartStepEffect = function (action) {
    ...
    if (steps[action.step].effects && !isFirstEnergize) {
        const transformedActions = ((_b = (_a = steps[action.step]) === null || _a === void 0 ? void 0 : _a.effects) === null || _b === void 0 ? void 0 : _b.map(effect => Object.assign(Object.assign({}, effect), { player: action.player, generatedBy: action.generatedBy }))) || [];
...
export const applyDrawRestOfCardsEffect = function (action, transform) {
...
export const applyMagiFlippedEffect = function (action, transform) {
    transform({
        type: ACTION_EFFECT,
        effectType: EFFECT_TYPE_MOVE_CARD_BETWEEN_ZONES,
...
export const applyAddStartingEnergyToMagiEffect = function (action, transform) {
