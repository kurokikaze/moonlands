...
export const applyMagiIsDefeatedEffect = function (action, transform) {
...
export const applyDiscardCreatureOrRelic = function (action, transform) {
    ...
    oneOrSeveral(discardTargets, target => {
        ...
        if (targetType === TYPE_CREATURE) {
            ...
            transform(Object.assign(Object.assign({ type: ACTION_EFFECT, effectType: EFFECT_TYPE_DISCARD_RELIC_FROM_PLAY, target }, (action.dueToMagiDefeat ? { dueToMagiDefeat: true } : {})), { generatedBy: action.generatedBy, player: action.player || 0 }));
        }
    });
};
export const applyDiscardRelicFromPlayEffect = function (action, transform) {
...
export const applyDiscardCreatureFromPlayEffect = function (action, transform) {
...
export const applyRearrangeCardsOfZoneEffect = function (action) {
