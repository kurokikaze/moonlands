...
const prompt = (data) => {
    switch (data.promptType) {
        ...
        case PROMPT_TYPE_DISTRIBUTE_CARDS_IN_ZONES: {
            const promptAction = Object.assign({ type: ACTION_ENTER_PROMPT }, data);
            return promptAction;
        }
...
const calculate = (data) => (Object.assign({ type: ACTION_CALCULATE }, data));
...
export const cards = [
    ...
    new Card('Ancestral Flute', TYPE_RELIC, REGION_UNIVERSAL, 0, {
        powers: [{
                ...
                effects: [
                    ...
                    getPropertyValue({
                        target: '$target',
                        property: PROPERTY_CREATURE_NAME,
    ...
    new Card('Orish', TYPE_CREATURE, REGION_ARDERIAL, 3, {
        powers: [
            {
                name: 'Hypnotize',
