...
export declare const ACTION_CHANGE = "actions/change";
...
export declare const PROPERTY_CREATURE_NAME = "properties/creature_name";
...
export declare const PROPERTY_ABLE_TO_USE_POWERS = "properties/able_to_use_powers";
...
export declare const SELECTOR_SELF_AND_STATUS = "selectors/self_and_status";
...
export declare const EFFECT_TYPE_ATTACKER_DAMAGE_DEALT = "effects/attacker_damage_dealt";
export declare const EFFECT_TYPE_DEFENDER_DAMAGE_DEALT = "effects/defender_damage_dealt";
...
export declare const EFFECT_TYPE_ENERGY_DISCARDED_FROM_CREATURE = "effects/energy_discarded_from_creature";
...
export declare const EFFECT_TYPE_ENERGY_DISCARDED_FROM_MAGI = "effects/energy_discarded_from_magi";
...
export declare const EFFECT_TYPE_DISCARD_CARD_FROM_HAND = "effects/discard_card_from_hand";
...
export declare const EFFECT_TYPE_EXECUTE_POWER_EFFECTS = "effects/execute_power_effects";
export declare const EFFECT_TYPE_PLAY_ATTACHED_TO_CREATURE = "effects/play_attached_to_creature";
export declare const EFFECT_TYPE_ATTACH_CARD_TO_CARD = "effects/attach_card_to_card";
export declare const EFFECT_TYPE_CARD_ATTACHED_TO_CARD = "effects/card_becomes_attached_to_card";
export declare const EFFECT_TYPE_PLAY_FINISHED = "effects/play_finished";
...
export declare const CHANGE_TYPE_START_TURN = "changes/start_turn";
export declare const CHANGE_TYPE_START_STEP = "changes/start_step";
export declare const CHANGE_TYPE_MOVE_CARD_BETWEEN_ZONES = "changes/move_card_between_zones";
export declare const CHANGE_TYPE_ADD_ENERGY_TO_CREATURE = "changes/add_energy_to_creature";
export declare const CHANGE_TYPE_ADD_ENERGY_TO_MAGI = "changes/add_energy_to_magi";
export declare const CHANGE_TYPE_DISCARD_ENERGY_FROM_CREATURE = "changes/discard_energy_from_creature";
export declare const CHANGE_TYPE_DISCARD_ENERGY_FROM_MAGI = "changes/discard_energy_from_magi";
export declare const CHANGE_TYPE_CREATE_CONTINUOUS_EFFECT = "changes/create_continuous_effect";
export declare const CHANGE_TYPE_CREATE_DELAYED_TRIGGER = "changes/create_delayed_trigger";
export declare const CHANGE_TYPE_CREATE_METADATA = "changes/create_metadata";
...
export declare const PROMPT_TYPE_DISTRIBUTE_CARDS_IN_ZONES = "prompt/distribute_cards_in_zones";
...
export declare const RESTRICTION_CREATURE_NAME = "restrictions/creature_name";
...
export declare const LOG_ENTRY_CARD_DISCARDED_FROM_HAND = "log_entry/card_discarded_from_hand";
...
export declare const LOG_ENTRY_CONTINUOUS_EFFECT_CREATED = "log_entry/continuous_effect_created";
