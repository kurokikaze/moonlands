...
export default function convertPromptActionToEffect(action, state) {
    ...
    switch (action.promptType) {
        case PROMPT_TYPE_NUMBER: {
            const effect = Object.assign(Object.assign({}, action), { type: ACTION_EFFECT, promptParams: {
                ...
                }, effectType: EFFECT_TYPE_PROMPT_ENTERED, generatedBy: action.generatedBy || 'the-game', player });
            return effect;
        }
        case PROMPT_TYPE_ALTERNATIVE: {
            const effect = Object.assign(Object.assign({}, action), { type: ACTION_EFFECT, effectType: EFFECT_TYPE_PROMPT_ENTERED, generatedBy: action.generatedBy || 'the-game', player });
            return effect;
        }
        case PROMPT_TYPE_ANY_CREATURE_EXCEPT_SOURCE: {
            const effect = Object.assign(Object.assign({}, action), { type: ACTION_EFFECT, effectType: EFFECT_TYPE_PROMPT_ENTERED, promptType: PROMPT_TYPE_ANY_CREATURE_EXCEPT_SOURCE, source: state.getMetaValue(action.source, action.generatedBy), generatedBy: action.generatedBy || 'the-game', player });
            return effect;
        }
        ...
        case PROMPT_TYPE_CHOOSE_N_CARDS_FROM_ZONE: {
            ...
            const effect = Object.assign(Object.assign({}, action), { type: ACTION_EFFECT, effectType: EFFECT_TYPE_PROMPT_ENTERED, promptType: PROMPT_TYPE_CHOOSE_N_CARDS_FROM_ZONE, promptParams: {
                    zone,
                    zoneOwner,
                    restrictions,
                    numberOfCards: maxNumberOfCards,
                    cards: cards.map(convertCard),
                }, generatedBy: action.generatedBy || 'the-game', player });
            return effect;
        }
        case PROMPT_TYPE_CHOOSE_UP_TO_N_CARDS_FROM_ZONE: {
            ...
            const cards = restrictions ? zoneContent.filter(state.makeCardFilter(restrictions)) : zoneContent;
            const maxNumberOfCards = Math.min(numberOfCards, cards.length);
            const effect = Object.assign(Object.assign({}, action), { type: ACTION_EFFECT, effectType: EFFECT_TYPE_PROMPT_ENTERED, generatedBy: action.generatedBy || 'the-game', promptParams: {
                    zone,
                    zoneOwner,
                    restrictions,
                    numberOfCards: maxNumberOfCards,
        ...
        case PROMPT_TYPE_DISTRIBUTE_DAMAGE_ON_CREATURES: {
            const effect = Object.assign(Object.assign({}, action), { type: ACTION_EFFECT, effectType: EFFECT_TYPE_PROMPT_ENTERED, promptParams: {
        ...
        case PROMPT_TYPE_MAGI_WITHOUT_CREATURES: {
            const effect = Object.assign(Object.assign({}, action), { type: ACTION_EFFECT, effectType: EFFECT_TYPE_PROMPT_ENTERED, promptType: action.promptType, generatedBy: action.generatedBy || 'the-game', player });
            return effect;
        }
        case PROMPT_TYPE_MAY_ABILITY: {
            const effect = Object.assign(Object.assign({}, action), { type: ACTION_EFFECT, effectType: EFFECT_TYPE_PROMPT_ENTERED, promptType: PROMPT_TYPE_MAY_ABILITY, generatedBy: action.generatedBy || 'the-game', player });
            return effect;
        }
        ...
        case PROMPT_TYPE_NUMBER_OF_CREATURES_FILTERED: {
            const effect = Object.assign(Object.assign({}, action), { type: ACTION_EFFECT, promptType: action.promptType, effectType: EFFECT_TYPE_PROMPT_ENTERED, generatedBy: action.generatedBy || 'the-game', player });
            return effect;
        }
        ...
        case PROMPT_TYPE_PLAYER: {
            const effect = Object.assign(Object.assign({}, action), { type: ACTION_EFFECT, promptType: PROMPT_TYPE_PLAYER, effectType: EFFECT_TYPE_PROMPT_ENTERED, generatedBy: action.generatedBy || 'the-game', player });
            return effect;
        }
