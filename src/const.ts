...
export const ACTION_CHANGE = 'actions/change';
...
export const EFFECT_TYPE_ATTACKER_DAMAGE_DEALT = 'effects/attacker_damage_dealt';
export const EFFECT_TYPE_DEFENDER_DAMAGE_DEALT = 'effects/defender_damage_dealt';
...
export const EFFECT_TYPE_ENERGY_DISCARDED_FROM_CREATURE = 'effects/energy_discarded_from_creature';
export const EFFECT_TYPE_REMOVE_ENERGY_FROM_CREATURE = 'effects/remove_energy_from_creature';
...
export const EFFECT_TYPE_ENERGY_DISCARDED_FROM_MAGI = 'effects/energy_discarded_from_magi';
export const EFFECT_TYPE_REMOVE_ENERGY_FROM_MAGI = 'effects/remove_energy_from_magi';
...
export const EFFECT_TYPE_DISCARD_CARD_FROM_HAND = 'effects/discard_card_from_hand';
...
export const CHANGE_TYPE_FIND_STARTING_CARDS = 'changes/find_starting_cards';
export const CHANGE_TYPE_START_TURN = 'changes/start_turn';
export const CHANGE_TYPE_START_STEP = 'changes/start_step';
export const CHANGE_TYPE_MOVE_CARD_BETWEEN_ZONES = 'changes/move_card_between_zones';
export const CHANGE_TYPE_ADD_ENERGY_TO_CREATURE = 'changes/add_energy_to_creature';
export const CHANGE_TYPE_ADD_ENERGY_TO_MAGI = 'changes/add_energy_to_magi';
export const CHANGE_TYPE_DISCARD_ENERGY_FROM_CREATURE = 'changes/discard_energy_from_creature';
export const CHANGE_TYPE_DISCARD_ENERGY_FROM_MAGI = 'changes/discard_energy_from_magi';
export const CHANGE_TYPE_CREATE_CONTINUOUS_EFFECT = 'changes/create_continuous_effect';
export const CHANGE_TYPE_CREATE_DELAYED_TRIGGER = 'changes/create_delayed_trigger';
export const CHANGE_TYPE_CREATE_METADATA = 'changes/create_metadata';
...
export const LOG_ENTRY_CARD_DISCARDED_FROM_HAND = 'log_entry/card_discarded_from_hand';
...
export const LOG_ENTRY_DIE_ROLLED = 'log_entry/die_rolled';
